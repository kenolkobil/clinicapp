...
public class Caregiverslogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caregiverslogin);
                    ...
                    firebaseAuth.signInWithEmailAndPassword(admin_email.getText().toString(),admin_password.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>()
                    {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                startActivity(new Intent(getApplicationContext(),Doctors_menu.class));
                            }
                        }
